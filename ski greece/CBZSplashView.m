...
+ (instancetype)splashViewWithIcon:(UIImage *)icon backgroundImage:(UIImage *)imageBg
{
    /* This component is useless without an icon */
    NSParameterAssert(icon);
    
    return [[CBZRasterSplashView alloc] initWithIconImage:icon backgroundImage:imageBg];
}
