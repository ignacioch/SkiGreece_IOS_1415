...
- (void)viewDidLoad
{
    ...
    if (IS_IPHONE_6) {
        ...
        self.LiftsMain.frame = CGRectMake(self.LiftsMain.frame.origin.x, self.LiftsMain.frame.origin.y + OFFSET_IOS_7, SCREEN_WIDTH, SCREEN_HEIGHT - (self.LiftsMain.frame.origin.y + OFFSET_IOS_7));
    } else if (IS_IPHONE_5) {
